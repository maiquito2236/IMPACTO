...
@section('titulo', 'Gestión de Consultorios - Panel Admin')
        ...
        <section class="kpi-grid-c">
            ...
            <div class="kpi-card kpi-card-green">
                ...
                <div class="kpi-text">
                    ...
                    <span class="kpi-number" id="kpi-asignados">0</span>
            ...
            <div class="kpi-card kpi-card-orange">
                ...
                <div class="kpi-text">
                    ...
                    <span class="kpi-number" id="kpi-disponibles">0</span>
            ...
            <div class="kpi-card kpi-card-purple">
                ...
                <div class="kpi-text">
                    ...
                    <span class="kpi-number" id="kpi-odontologos">0</span>
...
@push('scripts')
    ...
    <script src="{{ asset('js/administrador/consultorio.js') }}"></script>
@endpush