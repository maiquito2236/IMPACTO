...
@section('titulo', 'Gestión de Usuarios - Panel Admin')

@push('css')
    <link rel="stylesheet" href="{{ asset('css/administrador/gestion_usuario.css') }}">
...
@section('contenido')
            ...
            <form id="formUsuario">
                ...
                <div id="camposOdontologoCrear" style="display: none;">
                    <div class="form-group">
                        ...
                        <div id="containerEspecialidadesCrear" class="checkbox-group" style="max-height: 150px; overflow-y: auto; border: 1px solid #d1d5db; border-radius: 4px; padding: 10px;"></div>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <form id="formEditarRol">
                ...
                <div id="camposOdontologo" style="display: none;">
                    <div class="form-group">
                        <label>Especialidades</label>
                        <div id="containerEspecialidades" class="checkbox-group" style="max-height: 150px; overflow-y: auto; border: 1px solid #d1d5db; border-radius: 4px; padding: 10px;"></div>
                    </div>
                    <div class="form-group">
                        <label>Consultorio</label>
                ...
                <div id="alertaAdminJefe" style="display: none; margin-bottom: 15px; padding: 12px; background-color: #fee2e2; border-left: 4px solid #ef4444; color: #991b1b; border-radius: 4px; font-size: 14px;">
                    <i class="fa-solid fa-triangle-exclamation"></i> <strong>Protección de Seguridad:</strong> Este usuario posee el cargo de Administrador Jefe y no puede ser alterado.
                </div>
                <div id="alertaAdminNormal" style="display: none; margin-bottom: 15px; padding: 12px; background-color: #fffbeb; border-left: 4px solid #f59e0b; color: #b45309; border-radius: 4px; font-size: 14px;">
                    <i class="fa-solid fa-lock"></i> <strong>Acción Restringida:</strong> No tienes permisos para modificar a otros administradores.
                </div>
    ...
    <!-- Variable de Sesión Dinámica -->
    <input type="hidden" id="rolSesionActual" value="{{ Auth::check() ? Auth::user()->ROLES_ID_ROLES : 1 }}">
@endsection

@push('scripts')
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <script src="{{ asset('js/administrador/gestion_usuario.js') }}"></script>
@endpush