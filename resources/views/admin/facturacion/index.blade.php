...
@section('titulo', 'Sistema de Facturación - Panel Admin')

@push('css')
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/1.13.6/css/jquery.dataTables.min.css">
    <link rel="stylesheet" href="https://cdn.datatables.net/buttons/2.4.1/css/buttons.dataTables.min.css">
    <link rel="stylesheet" href="{{ asset('css/administrador/facturacion.css') }}">
...
@section('contenido')
    <header class="header">
        <div class="header-title">
            ...
            <p>Gestión de ingresos, comisiones y cobros</p>
        </div>
    </header>
    ...
    <section class="kpi-grid">
        <div class="kpi-card">
            ...
            <div class="kpi-info">
                ...
                <div class="number" id="kpiIngresosDia">$ 0.00</div>
            </div>
        </div>
        <div class="kpi-card">
            ...
            <div class="kpi-info">
                ...
                <div class="number" id="kpiIngresosMes">$ 0.00</div>
            </div>
        </div>
        <div class="kpi-card">
            ...
            <div class="kpi-info">
                ...
                <div class="number" id="kpiAbonosMes">$ 0.00</div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-info">
                ...
                <div class="number" id="kpiDeudasPendientes">$ 0.00</div>
    ...
    <div class="dashboard-grid">
        <div class="left-col">
            <div class="panel">
                ...
                <!-- Tab 2: Configuración de Comisiones -->
                ...
                <!-- Tab 3: Liquidación a Odontólogos -->
...
@push('scripts')
    ...
    <script src="{{ asset('js/administrador/facturacion.js') }}"></script>
@endpush
