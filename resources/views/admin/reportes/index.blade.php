...
@section('titulo', 'Reportes y Estadísticas - Panel Admin')

@push('css')
    <link rel="stylesheet" href="{{ asset('css/administrador/reportes.css') }}">
...
@push('scripts')
    ...
    <script src="{{ asset('js/administrador/reportes.js') }}"></script>
@endpush
