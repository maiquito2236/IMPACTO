...
use App\Models\administrador\NotificacionAdminModel;
use Exception;
...
class NotificacionAdminController {
    ...
    public function __construct() {
        $this->modelo = new NotificacionAdminModel();
    }

    /**
     * Renderiza la vista principal de notificaciones del administrador.
    ...
    public function index(): void {
        ...
        require_once __DIR__ . '/../../Views/administrador/notificaciones.php';
    }

    /**
     * Devuelve todas las notificaciones en JSON.
     * action = admin/notificaciones/listar
     */
     ...
     * action = admin/notificaciones/marcar_leida
     */
     ...
     * action = admin/notificaciones/marcar_todas
     */
